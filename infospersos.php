  ...
  <body class="page-5">
    ...
    <div class="recap-etapes col-sm-12">
      <div class="container" id="container-infos">
        ...
        <div class="next"></div>
        <?php
          echo '<a href="/flyingpapers/porteaporte.php?id_billet=' . $_SESSION['billet_id'] .'&total2=' . $_SESSION["total2"] . '&opt1_p=' . $_SESSION["opt1_p"] . '&opt1=' . $_SESSION["opt1"] . '&opt2_p=' . $_SESSION["opt2_p"] . '&opt2=' . $_SESSION["opt2"] . '" class="a2-i a">';
        ?>
          <p class="num-e">2</p>
        ...
        <?php
        echo'
        <a href="/flyingpapers/porteaporte.php?id_billet=' . $_SESSION['billet_id'] .'&total2=' . $_SESSION["total2"] . '&opt1_p=' . $_SESSION["opt1_p"] . '&opt1=' . $_SESSION["opt1"] . '&opt2_p=' . $_SESSION["opt2_p"] . '&opt2=' . $_SESSION["opt2"] . '" class="previous">
      ...
      <div class="container">
        <div class="wrapper">
          ...
          <div class="grid-row2">
            ...
            if(isset($_GET["totalb"])) {$_SESSION["totalb"] = $_GET["totalb"];}
            if(isset($_GET["opt-pap"])) {$_SESSION["opt_pap"]= $_GET["opt-pap"];}
            if(isset($_GET["opt-papb"])) {$_SESSION["optb_pap"]= $_GET["opt-papb"];}
            //verification : 
